                ...
                <tbody><tr>
                    <td align="center" valign="top">
                        ...
                        <table class="container header" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
                            <tbody><tr>
                                <td style="padding: 30px 0 30px 0; border-bottom: solid 1px #eeeeee;" align="left">
                                    <a href="#" style="font-size: 30px; text-decoration: none; color: #000000;">LEFEBVRE HAROLD</a>
                                </td>
                            </tr>
                            </tbody></table>
                        <!-- /// Header -->
                        ...
                        <table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620" style="width: 620px;">
                            <tbody><tr>
                                <td class="hero-subheader__title" style="font-size: 43px; font-weight: bold; padding: 80px 0 15px 0;" align="left"><?=$sujet;?></td>
                            </tr>
                                        ...
                                        <tbody><tr>
                                                ...
                                                <table class="container" border="0" cellpadding="0" cellspacing="0" align="center">
                                                    <tbody><tr>
                                                        <td class="info-bullets__icon" style="padding: 0 15px 0 0;">
                                                            <img src="https://lefebvreharold.fr/assets/img/img13.png" alt="email">
                                                        </td>

                                                        <td class="info-bullets__content" style="color: #969696; font-size: 16px;">s.lefebvre907@laposte.net</td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
                                            ...
                                            <td class="info-bullets__block" style="padding: 30px 30px 15px 30px;" align="center">
                                                <table class="container" border="0" cellpadding="0" cellspacing="0" align="center">
                                                    <tbody><tr>
                                                        <td class="info-bullets__icon" style="padding: 0 15px 0 0;">
                                                            <img src="https://lefebvreharold.fr/assets/img/img11.png" alt="T&eacute;l&eacute;phone">
                                                        </td>

                                                        <td class="info-bullets__content" style="color: #969696; font-size: 16px;">06.10.01.25.48</td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="info-bullets__block" style="padding: 30px;" align="center">
                                                <table class="container" border="0" cellpadding="0" cellspacing="0" align="center">
                                                    <tbody><tr>
                                                        <td class="info-bullets__icon" style="padding: 0 15px 0 0;">
                                                            <img src="https://lefebvreharold.fr/assets/img/img12.png" alt="Adresse postale">
                                                        </td>

                                                        <td class="info-bullets__content" style="color: #969696; font-size: 16px;">15 rue marcellin berthelot 80090, Amiens</td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
                        ...
                        <table class="container" border="0" cellpadding="0" cellspacing="0" width="620" align="center" style="border-top: 1px solid #eeeeee; width: 620px;">
                            <tbody><tr>
                                ...
                                <td align="center" style="padding: 30px 0 30px 0;">
                                    <a href="https://www.linkedin.com/in/harold-lefebvre/">
                                        <img src="https://lefebvreharold.fr/assets/img/linkedin-mail.png" border="0" alt="linkedin">
                                    </a>
                                </td>

                                <td align="center" style="padding: 30px 0 30px 0;">
                                    <a href="https://github.com/Lefhar/">
                                        <img src="https://lefebvreharold.fr/assets/img/github-mail.png" border="0"  alt="github">
                                    </a>
                                </td>

                                <td align="center" style="padding: 30px 0 30px 0;">
                                    <a href="https://lefebvreharold.fr">
                                        <img src="https://lefebvreharold.fr/assets/img/world-wide-web.png" border="0"  alt="portfolio">
                                    </a>
                                </td>
                            </tr>
                            </tbody></table>
