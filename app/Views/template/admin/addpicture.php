                    ...
                    <form class="user" action=""  id="formcv" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control "
                                ...
                                <option value="<?php if (set_value('emplacement') =="profil" or set_value('emplacement') =="") {
                                    echo "profil";
                                } else {
                                    echo "sociaux";
                                } ?>"><?php if (set_value('emplacement') =="profil" or set_value('emplacement') =="") {
                                        echo "profil";
                                    } else {
                                        echo "sociaux";
                                    } ?></option>
                                <option value="<?php if (set_value('emplacement') == "sociaux") {
                                    echo "profil";
                                } else {
                                    echo "sociaux";
                                } ?>"><?php if (set_value('emplacement') == "sociaux") {
                                        echo "profil";
                                    } else {
                                        echo "sociaux";
                                    } ?></option>
