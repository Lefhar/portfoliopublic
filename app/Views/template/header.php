...
<body>
<header>
    <nav class="navbar navbar-expand-sm fixed-top navbar-light navbar-dark ">
        <!--bouton sur mobile-->
        <div class="container">
            <a class="nav-brand navbar-text" href="#portfoliovu">Lefebvre Harold</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"   href="#portfoliovu">Portfolio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"   href="#main">Mon CV</a>
                    </li>
                    <li class="nav-item">
